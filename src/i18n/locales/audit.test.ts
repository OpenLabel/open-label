...
const perLanguageAllowedValues: Record<string, string[]> = {
  bg: ["Open Source"],
  cs: ["Open Source", "Region", "Model", "Role", "Web"],
  da: ["Open Source", "Region", "Protein", "Salt", "Allergen", "Model", "Customs code", "Status", "Web", "EU Safety Gate Portal"],
  de: ["Open Source", "Details", "Region", "Allergen", "Code", "Material", "Status", "Web", "EU Safety Gate Portal", "Powered by"],
  el: ["Open Source", "Email"],
  es: ["Open Source", "Manual", "Error", "Alcohol", "General", "Material", "Experimental", "Web"],
  et: ["Open Source", "SKU / variant", "Number {{value}}", "Powered by"],
  fi: ["Open Source"],
  fr: ["Open Source", "Volume", "Batteries", "Code", "Capsule", "Substance", "Concentration", "Web"],
  ga: ["Open Source"],
  hr: ["Open Source", "Model", "Status"],
  hu: ["Open Source", "Web"],
  it: ["Open Source", "Email", "Password", "Volume", "Web"],
  lt: ["Open Source"],
  lv: ["Open Source"],
  mt: ["Open Source", "Email", "Password", "Powered by", "Vintage", "Status", "Web"],
  nl: ["Open Source", "Volume", "Details", "Alcohol", "Code", "Capsule", "QR Code", "Model", "SKU / variant", "Website", "Status", "Web", "EU Safety Gate Portal"],
  pl: ["Open Source", "Region", "Model", "Status"],
  pt: ["Open Source", "Volume", "Manual", "Material", "Experimental", "Web"],
  ro: ["Open Source", "Manual", "General", "Material", "Experimental", "Model", "Web"],
  sk: ["Open Source", "Model", "SKU / variant", "Web"],
  sl: ["Open Source", "Material", "Model", "Status"],
  sv: ["Open Source", "Region", "Protein", "Salt", "Allergen", "Material", "SKU / variant", "Status", "EU Safety Gate Portal"],
};
