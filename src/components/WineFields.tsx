...
export function WineFields({ data, onChange }: WineFieldsProps) {
  ...
  const INGREDIENT_ALIASES: Record<string, string> = {
    ...
    'potassium metabisulfite': 'potassium_metabisulfite',
    'potassium bisulfite': 'potassium_bisulfite',
    'metatartaric acid': 'metatartaric_acid',
    'fumaric acid': 'fumaric_acid',
    'calcium sulfate': 'calcium_sulfate',
    'carboxymethylcellulose': 'carboxymethylcellulose',
    'potassium polyaspartate': 'potassium_polyaspartate',
    'yeast mannoproteins': 'yeast_mannoproteins',
    ...
    'potato protein': 'potato_protein',
    'pvpp': 'pvpp',

    // E-numbers (with and without space)
    ...
    'e 941': 'nitrogen',
    'e941': 'nitrogen',
    'e 290': 'carbon_dioxide',
    'e290': 'carbon_dioxide',
    'e 516': 'calcium_sulfate',
    'e516': 'calcium_sulfate',
    'e 466': 'carboxymethylcellulose',
    'e466': 'carboxymethylcellulose',
    'e 456': 'potassium_polyaspartate',
    'e456': 'potassium_polyaspartate',
    'e 297': 'fumaric_acid',
    'e297': 'fumaric_acid',

    // French aliases
    'acide tartrique': 'tartaric_acid',
    'acide malique': 'malic_acid',
    'acide lactique': 'lactic_acid',
    'acide citrique': 'citric_acid',
    'acide ascorbique': 'ascorbic_acid',
    'gomme arabique': 'gum_arabic',
    'dioxyde de soufre': 'sulfur_dioxide',
    'sulfites': 'sulfites',
    'sorbate de potassium': 'potassium_sorbate',
    'metabisulfite de potassium': 'potassium_metabisulfite',
    'bisulfite de potassium': 'potassium_bisulfite',
    'gélatine': 'gelatin',
    'caséine': 'casein',
    'albumine': 'albumin',
    'colle de poisson': 'isinglass',
    'protéine de pois': 'pea_protein',
    'acide métatartrique': 'metatartaric_acid',
    'acide fumarique': 'fumaric_acid',
    'sulfate de calcium': 'calcium_sulfate',
    'lait': 'milk',
    'œuf': 'egg',
    'oeuf': 'egg',
    'contient des sulfites': 'sulfites',

    // Italian aliases
    'acido tartarico': 'tartaric_acid',
    'acido malico': 'malic_acid',
    'acido lattico': 'lactic_acid',
    'acido citrico': 'citric_acid',
    'acido ascorbico': 'ascorbic_acid',
    'gomma arabica': 'gum_arabic',
    'anidride solforosa': 'sulfur_dioxide',
    'solfiti': 'sulfites',
    'sorbato di potassio': 'potassium_sorbate',
    'gelatina': 'gelatin',
    'caseina': 'casein',
    'albumina': 'albumin',
    ...
    'uovo': 'egg',
    'latte': 'milk',
    'contiene solfiti': 'sulfites',

    // German aliases
    'schwefeldioxid': 'sulfur_dioxide',
    'sulfit': 'sulfites',
    'weinsäure': 'tartaric_acid',
    'zitronensäure': 'citric_acid',
    'milchsäure': 'lactic_acid',
    'apfelsäure': 'malic_acid',
    'ascorbinsäure': 'ascorbic_acid',
    'gummi arabicum': 'gum_arabic',
    'kaliumsorbat': 'potassium_sorbate',
    'kaliummetabisulfit': 'potassium_metabisulfite',
    'kasein': 'casein',
    'hausenblase': 'isinglass',
    'ei': 'egg',
    'eier': 'egg',
    'milch': 'milk',
    'enthält sulfite': 'sulfites',
    'enthält sulfit': 'sulfites',

    // Spanish aliases
    'ácido tartárico': 'tartaric_acid',
    'ácido málico': 'malic_acid',
    'ácido láctico': 'lactic_acid',
    'ácido cítrico': 'citric_acid',
    'ácido ascórbico': 'ascorbic_acid',
    'goma arábiga': 'gum_arabic',
    'dióxido de azufre': 'sulfur_dioxide',
    'sulfitos': 'sulfites',
    'sorbato de potasio': 'potassium_sorbate',
    'caseína': 'casein',
    'albúmina': 'albumin',
    'ictiocola': 'isinglass',
    ...
    'huevo': 'egg',
    'leche': 'milk',
    'contiene sulfitos': 'sulfites',

    // Portuguese aliases (only entries not already covered by Spanish)
    'dióxido de enxofre': 'sulfur_dioxide',
    'goma arábica': 'gum_arabic',
    'contém sulfitos': 'sulfites',
  };
